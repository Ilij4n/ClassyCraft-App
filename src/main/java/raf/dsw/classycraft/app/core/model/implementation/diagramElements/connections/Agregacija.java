...
public class Agregacija extends Connection{
    public Agregacija(ClassyNode parent, String name, Paint paint, int stroke, InterClass element1, InterClass element2, String kardinalnost, String imePromenljive) {
